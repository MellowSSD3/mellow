	...
	$(document).ready(function(){
		...
		if ($('.hc-tabs').length>0) {
			$(window).load(function() {
				...
				$('.vertical-images > .nav.nav-tabs li a').on('click', function (event) {
        ...
        if ($(".event-form").length > 0) {
            $(".event-form").validate({
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.response == "success") {
                                ...
                                $(this).find("#eventSuccess").removeClass("hidden");
                                $(this).find("#eventError").addClass("hidden");
                                ...
                                if (($(this).find("#eventSuccess").position().top - 80) < $(window).scrollTop()) {
                                    $("html, body").animate({
                                        scrollTop: $(this).find("#eventSuccess").offset().top - 80
                                    }, 300);
                                }

                            } else {

                                $(this).find("#eventError").removeClass("hidden");
                                $(this).find("#eventSuccess").addClass("hidden");

                                if (($(this).find("#eventError").position().top - 80) < $(window).scrollTop()) {
                                    $("html, body").animate({
                                        scrollTop: $(this).find("#eventError").offset().top - 80
                                    }, 300);
                                }
                ...
                messages: {
                    ...
                    address: {
                        required: "Please enter an Adrress"
                    },
                    message: {
